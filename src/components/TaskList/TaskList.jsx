...
import { getCompletedTasks, getNewTasks, getUncompletedTasks, updateReminderStatus } from "@/redux/Tasks/TasksSlice";
  ...
  const handleComplete = () => {
    dispatch(
      showModal({
        modalData: {
          action:
            currentPath === "uncompleted-tasks" || currentPath === "new-tasks" || currentPath === ""
              ? "markTaskAsComplete"
              : "markTaskAsUncomplete",
          payload: data?.id,
          title:
            currentPath === "uncompleted-tasks" || currentPath === "new-tasks" || currentPath === ""
  ...
  return (
    <section
      className={cx(
        ...
        "flexCol",
        data?.reminder?.status && currentPath !== "deleted-tasks" ? styles.reminderActive : styles.reminderInactive
      )}
    >
      ...
      {currentPath !== "deleted-tasks" ? (
        <footer className={cx(styles.btnGroup, "flexRow-right-centered")}>
          <Button
            title={currentPath === "completed-tasks" ? "Mark as Incomplete" : "Mark as Complete"}
